// 44 Count Positive Numbers in Array.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
short CountPositiveNumbers(short Arr[100], short ArrLength) {
    short Counter = 0;
    for (short i = 0; i < ArrLength; i++) {
        if (Arr[i] > 0)
            Counter++;
...
int main()
{
    ...
    cout << "\nPositive Numbers Count in Array: " << CountPositiveNumbers(Arr, ArrLength) << endl;
