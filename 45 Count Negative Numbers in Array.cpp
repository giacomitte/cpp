// 45 Count Negative Numbers in Array.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
short CountNegativeNumbers(short Arr[100], short ArrLength) {
...
int main()
{
    ...
    cout << "\nNegative Numbers Count in Array: " << CountNegativeNumbers(Arr, ArrLength) << endl;
