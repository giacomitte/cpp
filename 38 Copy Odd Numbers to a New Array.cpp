// 38 Copy Odd Numbers to a New Array.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void CopyOddNumbers(short ArrSource[100], short ArrDestination[100], short ArrLength, short& Arr2Length) {
...
int main()
{
    ...
    CopyOddNumbers(ArrSource, ArrDestination, ArrLength, Arr2Length);
    cout << "\nArray Elements After Copy Odd Numbers: \n";
